...
class DirectDetailTests(unittest.TestCase):
    ...
    def test_homepage_simplification_and_links(self):
        ...
        self.assertIn('Das DiGA Verzeichnis ändert sich ständig. Neue DiGA kommen hinzu, bestehende ändern sich (z.B. Preis, Laufzeiten, Evidenz, usw.) oder werden entfernt.',markup)
    ...
    def test_selected_group_only_with_all_adjustments_and_reload(self):
        ...
        self.assertEqual(fresh.title[0].value,'Änderungen')
